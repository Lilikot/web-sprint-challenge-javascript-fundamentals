...
//🚀🚀🚀 ⬇️ 📝 Explanation ⬇️ 📝 🚀🚀🚀: 
// The variable named "internal" is accessible only within the "myFunction" scope, but inaccessible outside. 
//Because the "nestedFunction" is in the "myFunction" scope, it can access what's in the "myFunction". 
...
const zooAnimals = [
  ...
  */
  ...
  function USApop(array){
    const USApops = array.reduce((total, item)=> {
